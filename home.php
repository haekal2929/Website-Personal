 ...
 <header class="bg-dark py-5" id="main-header">
    <div class="container h-100 d-flex align-items-end justify-content-center w-100">
        <div class="text-center text-white w-100">
            ...
            <p class="lead fw-normal text-white-50 mb-0">Kami siap merawat kendaraan Anda</p>
            <div class="col-auto mt-2">
                <button class="btn btn-primary btn-lg rounded-0" id="send_request" type="button">Kirim Permintaan Layanan</button>
            </div>
        </div>
    </div>
</header>
...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row">
            <div class="col-md-4">
                <h3 class="text-center">Kami Melayani Kendaraan:</h3>
