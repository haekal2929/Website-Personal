        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="category_id" class="control-label">Type Kendaraan</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="vehicle_name" class="control-label">Nama Kendaraan</label>
                    <input type="text" name="vehicle_name" id="vehicle_name" class="form-control form-control-sm rounded-0" required>
                </div>
                <div class="form-group">
                    <label for="vehicle_registration_number" class="control-label">No Kendaraan</label>
                ...
                <div class="form-group">
                    <label for="vehicle_model" class="control-label">Model Kendaraan</label>
                ...
                <div class="form-group">
                    <label for="service_type" class="control-label">Jenis Permintaan</label>
                ...
                <div class="form-group" style="display:none">
                    <label for="pickup_address" class="control-label">Alamat Penjemputan</label>
